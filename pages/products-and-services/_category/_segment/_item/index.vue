...
export default {
    ...
    head() {
        return {
            ...
            meta: [
            {
                new_url: this.productData.category.category_title,
                title: this.productData.segment.title,
                meta_description : this.productData.item.meta_description,
                body_text: this.productData.item.description,
                client_url: this.productData.item.link
            },
            {
                primary_keyword: this.productData.item.primary_keyword,
                secondary_keywords: this.productData.item.secondary_keywords
